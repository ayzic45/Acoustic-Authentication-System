...
if(count($_POST)>0) 
{
               ...
               $result = mysqli_query($conn, $query);
                       ...
                       {  
                            ...
                            {
                                 if($PIN == $row["PIN"] && $row["control"] !=1)  
                                 {    
                                            $_SESSION['username'] = $username; 
                                            header("location: play.php?user=$username");
            
                                 }
                                 else if($PIN == $row["PIN"] && $row["control"] ==1)  
                                 {    
                                              $_SESSION['username'] = $username;
                                 ...
                                 {  
                                    ...
                                    header("location: incorrect-password1.php");
                                 } 
                            }
                       }
                      else 
                      {  
                         ...
                         header("location: account-not-found1.php");
                      }
...
<html lang="en-us">
    <head>
        ...
        <title>UKZN ACOUSTIC AUTHENTICATION - TRANSMITTER</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <div id="container">
          ...
          <h1 name="text" id="text"  style="font-size:14pt">Login</h1>
            ...
            <input type="password" minlength="4" maxlength="4" required name="PIN" placeholder="PIN" id="PIN" >
            <a>
