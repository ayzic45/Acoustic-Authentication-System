...
acoustic_auth_data = 'TEST1-QUITE ENV.wav';
[data_set, y] = audioread(acoustic_auth_data);
x = data_set ; % column to row vector conversion
sound(x, y);
%use the plot_funct
plot_func(x, fs,'Amplitude', 'QUITE ENV: CAPTURED WAVEFORM FOR "UKZN-ACOUSTIC-AUTHENTICA"');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    2
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Captured Signal for "UKZN#CodeTest1234_5"
acoustic_auth_data = 'TEST2-QUITE ENV.wav';
[data_set, y] = audioread(acoustic_auth_data);
x = data_set ; % column to row vector conversion
sound(x, y);
plot_func(x, fs,'Amplitude', 'QUITE ENV: CAPTURED WAVEFORM FOR "UKZN#CodeTest1234_5"');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Captured Signal for "UKZN#CodeTest1234_5"
acoustic_auth_data = 'AYA796-QUITE ENV.wav';
[data_set, y] = audioread(acoustic_auth_data);
x = data_set ; % column to row vector conversion
sound(x, y);
plot_func(x, fs,'Amplitude', 'QUITE ENV: CAPTURED WAVEFORM FOR "DeopvJBqVH4xzMmjAPE02gu"');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Captured Signal for "UKZN#CodeTest1234_5"
acoustic_auth_data = 'AYA4545-QUITE ENV.wav';
[data_set, y] = audioread(acoustic_auth_data);
x = data_set ; % column to row vector conversion
sound(x, y);
plot_func(x, fs,'Amplitude', 'QUITE ENV: CAPTURED WAVEFORM FOR "7zAM5OhYmNdu9gJy1QVSZI2e"');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                    5
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Captured Signal for "UKZN#CodeTest1234_5"
acoustic_auth_data = 'Sabza18-QUITE ENV.wav';
[data_set, y] = audioread(acoustic_auth_data);
x = data_set ; % column to row vector conversion
sound(x, y);
plot_func(x, fs,'Amplitude', 'QUITE ENV: CAPTURED WAVEFORM FOR "kXNZBmjYTLqFMCcEgv-tedo3"');
